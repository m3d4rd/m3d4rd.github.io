...
function SecondPage() {
  ...
  where your heart is.
    ...
    <div className="text-6xl  flex-col text-center  mx-auto">
      <div className="mt-24 w-7/12 place-self-center mx-auto  text-4xl">

        <img className=" w-3/4 mx-auto mt-24" src={people} />
        <div className="my-16">
          <span className="font-extrabold ">Hey we are 100+ members away, <a href="#" style={{color: '#0D51FF'}}>click here </a>
 to invite your friends to join!</span>
        </div>
        <div>
        </div>
      </div>
